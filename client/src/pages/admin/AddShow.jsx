  ...
  return nowPlayingMovies.length > 0 ? (
    <>
          ...
          {nowPlayingMovies.map((movie) => (
            <div
              ...
              className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300 ${
                selectedMovie === movie.id ? "border-2 border-primary rounded" : ""
              }`}
      ...
      <button
        ...
        disabled={addingShow}
        className="bg-primary text-white px-8 py-2 mt-4 rounded hover:bg-primary/90 transition-all cursor-pointer"
      >
        Add Show
      </button>
    </>
